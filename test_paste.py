#!/usr/bin/env python3
"""Test the paste functionality with Tactiq-style text"""
...
print("Testing paste functionality with Tactiq-style text...")
...
try:
    ...
    if response.status_code == 200:
        ...
        if 'transcript' in result:
            ...
            print("First 500 chars of transcript HTML:")
            print(transcript_html[:500])
    else:
